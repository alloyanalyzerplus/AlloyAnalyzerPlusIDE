 ...
 *
 * <p>
 * This implementation <i>does</i> support null values, despite how it is
 * annotated; see discussion at {@link ClassToInstanceMap}.
 *
...
public final class MutableClassToInstanceMap<B> extends ForwardingMap<Class< ? extends B>,B> implements ClassToInstanceMap<B>, Serializable {
     ...
     * empty {@code
     * backingMap}. The caller surrenders control of the backing map, and thus
     * should not allow any direct references to it to remain accessible.
     */
    ...
    /**
     * Wraps the {@code setValue} implementation of an {@code Entry} to enforce the
     * class constraint.
     */
    ...
    public Set<Entry<Class< ? extends B>,B>> entrySet() {
        return new ForwardingSet<Entry<Class< ? extends B>,B>>() {
            ...
            public Object[] toArray() {
                /*
                 * standardToArray returns `@Nullable Object[]` rather than `Object[]` but only
                 * because it can be used with collections that may contain null. This
                 * collection is a collection of non-null Entry objects (Entry objects that
                 * might contain null values but are not themselves null), so we can treat it as
                 * a plain `Object[]`.
                 */
    ...
    @CanIgnoreReturnValue
    @CheckForNull
    private static <B, T extends B> T cast(Class< ? extends B> class1, @CheckForNull
    B b) {
