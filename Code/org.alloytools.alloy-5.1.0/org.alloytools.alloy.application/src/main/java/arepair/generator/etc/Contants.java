...
import static arepair.generator.util.Util.initExprFromType;
...
import arepair.generator.fragment.op.All;
import arepair.generator.fragment.op.And;
import arepair.generator.fragment.op.Cardinality;
import arepair.generator.fragment.op.CrossProduct;
import arepair.generator.fragment.op.Difference;
import arepair.generator.fragment.op.Empty;
import arepair.generator.fragment.op.Equal;
import arepair.generator.fragment.op.Iff;
import arepair.generator.fragment.op.Implies;
import arepair.generator.fragment.op.In;
import arepair.generator.fragment.op.Intersect;
import arepair.generator.fragment.op.Join;
import arepair.generator.fragment.op.Lone;
import arepair.generator.fragment.op.No;
import arepair.generator.fragment.op.Not;
import arepair.generator.fragment.op.NotEqual;
import arepair.generator.fragment.op.NotIn;
import arepair.generator.fragment.op.One;
import arepair.generator.fragment.op.Or;
import arepair.generator.fragment.op.ReflexiveTransitiveClosure;
import arepair.generator.fragment.op.Set;
import arepair.generator.fragment.op.Some;
import arepair.generator.fragment.op.TransitiveClosure;
import arepair.generator.fragment.op.Transpose;
import arepair.generator.fragment.op.Union;
...
public class Contants {
    ...
    public static final TypeInfo                 NONE_TYPE_INFO              = of(CONST_NONE, 1, false, ImmutableList.of(NONE_TYPE), ImmutableList.of(Card.EMPTY));
    public static final TypeInfo                 UNIV_TYPE_INFO              = of(CONST_UNIV, 1, false, ImmutableList.of(UNIV_TYPE), ImmutableList.of(Card.SET));
    public static final TypeInfo                 IDEN_TYPE_INFO              = of(CONST_IDEN, 2, true, ImmutableList.of(UNIV_TYPE, UNIV_TYPE), ImmutableList.of(Card.SET, Card.SET));
    // We set the cardinality of Int to one because we do not want enumerate all subset of integers.
    public static final TypeInfo                 INT_TYPE_INFO               = of(CONST_INT, 1, false, ImmutableList.of(INT_TYPE), ImmutableList.of(Card.ONE));
    public static final TypeInfo                 ZERO_TYPE_INFO              = of(CONST_ZERO, 1, false, ImmutableList.of(INT_TYPE), ImmutableList.of(Card.ONE));
    public static final TypeInfo                 ONE_TYPE_INFO               = of(CONST_ONE, 1, false, ImmutableList.of(INT_TYPE), ImmutableList.of(Card.ONE));
    public static final TypeInfo                 STRING_TYPE_INFO            = of(CONST_STR, 1, false, ImmutableList.of(STR_TYPE), ImmutableList.of(Card.SET));
    public static final TypeInfo                 BOOLEAN_TYPE_INFO           = of(CONST_BOOL, 0, false, ImmutableList.of(BOOL_TYPE), ImmutableList.of(Card.ONE));
    ...
    public static final Expression               STRING_EXPR                 = initExprFromType(STRING_TYPE_INFO, STR_STRING + DOLLAR);

    // Special mapping.
    public static final Map<TypeInfo,Expression> SPECIAL_TYPE_TO_EXPRESSIONS = ImmutableMap.<TypeInfo, Expression> builder().put(NONE_TYPE_INFO, NONE_EXPR).put(UNIV_TYPE_INFO, UNIV_EXPR).put(IDEN_TYPE_INFO, IDEN_EXPR).put(INT_TYPE_INFO, INT_EXPR).put(ZERO_TYPE_INFO, ZERO_EXPR).put(ONE_TYPE_INFO, ONE_EXPR).put(STRING_TYPE_INFO, STRING_EXPR).build();
