...
public class IRule8 extends BinaryRule {
    ...
    public boolean isPruned() {
        return (opIsOr(leftRel.getOp(), PLUS) && (sameRelations(getChild(leftRel, 0), rightRel) || sameRelations(getChild(leftRel, 1), rightRel))) || (opIsOr(rightRel.getOp(), PLUS) && (sameRelations(getChild(rightRel, 0), leftRel) || sameRelations(getChild(rightRel, 1), leftRel)));
    }
}
