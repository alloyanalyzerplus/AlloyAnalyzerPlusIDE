...
public class TypeInfo {
    ...
    public static TypeInfo of(Node node, int arity, boolean hasIden, List<Type> types, List<Card> cards) {
    ...
    public String toString() {
        return "<node: " + node + ", arity: " + arity + ", hasIden: " + hasIden + ", types: " + types + ", cards: " + cards + ">";
    }
}
