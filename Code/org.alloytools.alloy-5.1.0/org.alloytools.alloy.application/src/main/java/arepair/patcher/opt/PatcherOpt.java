...
public class PatcherOpt extends Opt {
    ...
    public PatcherOpt(String modelPath, String testPath, int scope, SearchStrategy searchStrategy, boolean enableCaching, int minimumCost, int maxTryPerHole, int partitionNum, int maxTryPerDepth) {
