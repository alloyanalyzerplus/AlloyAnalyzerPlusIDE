	...
	implements CaretListener, DocumentListener, PropertyChangeListener
{
	...
	private final static Color border_color = new Color(223,223,223);
	private final static Border OUTER = new MatteBorder(0, 0, 0, 2, border_color);
	private Color lineColor = new Color(113, 113, 113);
	 ...
	 */
	public TextLineNumber(JTextComponent component){ this(component, 3); }
	...
	public TextLineNumber(JTextComponent component, int minimumDisplayDigits){
		...
		setBorderGap( 5 );
		setCurrentLineForeground( new Color(255, 54, 54) );
	...
	public void propertyChange(PropertyChangeEvent evt)
	{
		if (evt.getNewValue() instanceof Font)
		{
			if (updateFont)
			{
				...
				newFont = new Font(Font.SERIF, Font.PLAIN, newFont.getSize());
				setFont(newFont);
				lastDigits = 0;
				setPreferredWidth();
				repaint();
